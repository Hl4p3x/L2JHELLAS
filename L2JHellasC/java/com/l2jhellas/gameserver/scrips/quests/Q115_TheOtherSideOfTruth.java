...
public class Q115_TheOtherSideOfTruth extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("sculpture-06.htm"))
		{
			...
			final L2Npc stranger = addSpawn(SUSPICIOUS_MAN, player.getX() + 50, player.getY() + 50, player.getZ(), 0, false, 3100, false);
		...
		else if (event.equalsIgnoreCase("32022-02.htm"))
		{
			...
			final L2Npc stranger = addSpawn(SUSPICIOUS_MAN, player.getX() + 50, player.getY() + 50, player.getZ(), 0, false, 5100, false);
